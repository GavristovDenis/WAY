...
export const placesData: ListData[] = [
  {
    ...
    description:
      "Некоммерческий фонд развития современной культуры V–A–C был основан в 2009 году Леонидом Михельсоном. Одной из главных задач Фонда является разработка нового языка современных культурных процессов через выставочную, просветительскую, издательскую и перформативную деятельность совместно с художниками, исследователями и публикой. Выходя за рамки дисциплинарных границ в поле эксперимента, <h3>Фонд переосмысляет систему культурного производства и распространения знания</h3> </br> Ставя под вопрос конвенциональные иерархии экспертного и не-экспертного мнений, локального и глобального контекстов. Важным шагом на этом пути стало создание Дома культуры «ГЭС-2» — институции, способной представить ландшафт современной культуры во всем ее многообразии.",
